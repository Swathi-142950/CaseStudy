...
import { AuthServiceConfig, AuthService, FacebookLoginProvider } from 'angularx-social-login'
...
@NgModule({
    imports: [BrowserModule, FormsModule, MatDatepickerModule,BrowserAnimationsModule, MatInputModule, AdminPanelModule, MatNativeDateModule, ReactiveFormsModule, AppRouteModule, RouterModule.forChild([
